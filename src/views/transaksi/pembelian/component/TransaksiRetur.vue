<template>
  <section>
    <b-row class="match-height">
      ...
      <b-col lg="9" cols="12">
        <statistik :title="`Transaksi Retur Pembelian`" :data-transaksi="dataTransaksi" />
      </b-col>
      <b-col lg="12" cols="12">
        <b-card>
    ...
    loadTransaksi(dateawal = null, dateakhir = null) {
      ...
      store
        ...
        .then(res => {
          ...
          this.dataTransaksi = store.getters['app-transaksi-pembelian/getListTransaksiPembelianRetur']
          this.dataTemp = store.getters['app-transaksi-pembelian/getListTransaksiPembelianRetur']
        })
    },
    loadAwal() {
      // const d = new Date()
