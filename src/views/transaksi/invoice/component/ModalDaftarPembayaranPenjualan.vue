<template>
  <b-modal size="xl" id="modal-daftar-pembayaran-penjualan" title="Daftar Rincian Pembayaran" ok-title="Tutup" ok-only lazy>
...
export default {
  ...
  computed: {
    dataPembayaran() {
      return store.getters['app-transaksi-penjualan/getListPembayaran']
    },
  },
  methods: {
    moment(value) {
